...
test('CSV includes both statuses, BOM, CRLF, quoted newlines and neutralized formulas',async()=>{
 ...
 assert.ok(csv.startsWith('\uFEFFname,roast,roastDate,openedDate,ageDays,status,finishedAt\r\n'));
